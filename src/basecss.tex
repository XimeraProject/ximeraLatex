%%% This file contains all the CSS that is included on the osu website that Ximera tries to link to directly. Eventually the CSS should be ported to a local file so different schools can more easily change their CSS properties for the website.

@charset "UTF-8";
@import url(/node_modules/guppy-dev/build/guppy-default.min.css);
@import url(/node_modules/codemirror/lib/codemirror.css);
#guppymathModal {
  padding-right: 0; }

#guppymathModal .modal-dialog {
  padding: 6pt;
  max-width: 100%; }
...
.table, table.tabular {
  ...
  .table th,
  table.tabular th, .table td, table.tabular td {
    padding: 0.75rem;
    vertical-align: top;
    border-top: 1px solid #eceeef; }
  .table thead th, table.tabular thead th {
    vertical-align: bottom;
    border-bottom: 2px solid #eceeef; }
  .table tbody + tbody, table.tabular tbody + tbody {
    border-top: 2px solid #eceeef; }
  .table .table, table.tabular .table, .table table.tabular, table.tabular table.tabular {
    background-color: #fff; }
...
.has-danger .form-control-danger {
  background-image: url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' fill='%23bb0000' viewBox='-2 -2 7 7'%3E%3Cpath stroke='%23d9534f' d='M0 0l3 3m0-3L0 3'/%3E%3Ccircle r='.5'/%3E%3Ccircle cx='3' r='.5'/%3E%3Ccircle cy='3' r='.5'/%3E%3Ccircle cx='3' cy='3' r='.5'/%3E%3C/svg%3E"); }
...
.btn-danger {
  ...
  .btn-danger:focus, .btn-danger.focus {
    box-shadow: 0 0 0 2px rgba(187, 0, 0, 0.5); }
...
.card-inverse, .activity-card.active {
  color: rgba(255, 255, 255, 0.65); }
  .card-inverse .card-header, .activity-card.active .card-header,
  .card-inverse .card-footer,
  .activity-card.active .card-footer {
    background-color: transparent;
  ...
  .activity-card.active .card-blockquote {
    color: #fff; }
  .card-inverse .card-link, .activity-card.active .card-link,
  .card-inverse .card-text,
  .activity-card.active .card-text,
  .card-inverse .card-subtitle,
  .activity-card.active .card-subtitle,
  .card-inverse .card-blockquote .blockquote-footer,
  .activity-card.active .card-blockquote .blockquote-footer {
    color: rgba(255, 255, 255, 0.65); }
  .card-inverse .card-link:focus, .activity-card.active .card-link:focus, .card-inverse .card-link:hover, .activity-card.active .card-link:hover {
    color: #fff; }
...
.w-100, .theorem, .axiom, .conjecture, .corollary, .proposition, .lemma, .claim, .condition, .idea, .definition, .conclusion, .summary, .warning, .paradox, .example, .observation, .fact, .remark, .algorithm, .notation, .criterion, .exercise, .problem, .question, .explanation, .exploration, .model, .formula, .procedure, .template {
  width: 100% !important; }
...
.mt-3, .subsectionHead, .likesubsectionHead {
...
.btn-primary.pulsate {
  animation: pulsate-btn-primary 0.5s infinite alternate;
  animation-timing-function: linear;
  text-shadow: 0 0 8px #ccc; }

@keyframes pulsate-btn-primary {
  from {
...
.btn-success.pulsate {
  animation: pulsate-btn-success 0.5s infinite alternate;
  animation-timing-function: linear;
  text-shadow: 0 0 8px #ccc; }

@keyframes pulsate-btn-success {
  from {
    box-shadow: 0 0 10px #333;
    transform: rotate(-2deg); }
  to {
...
.btn-info.pulsate {
  animation: pulsate-btn-info 0.5s infinite alternate;
  animation-timing-function: linear;
  text-shadow: 0 0 8px #ccc; }

@keyframes pulsate-btn-info {
  from {
    box-shadow: 0 0 10px #333;
    transform: rotate(-2deg); }
  to {
...
.btn-warning.pulsate {
  animation: pulsate-btn-warning 0.5s infinite alternate;
  animation-timing-function: linear;
  text-shadow: 0 0 8px #ccc; }

@keyframes pulsate-btn-warning {
  from {
    box-shadow: 0 0 10px #333;
    transform: rotate(-2deg); }
  to {
...
.btn-danger.pulsate {
  animation: pulsate-btn-danger 0.5s infinite alternate;
  animation-timing-function: linear;
  text-shadow: 0 0 8px #ccc; }

@keyframes pulsate-btn-danger {
  from {
    box-shadow: 0 0 10px #333;
    transform: rotate(-2deg); }
  to {
...
.btn-inverse.pulsate {
  animation: pulsate-btn-inverse 0.5s infinite alternate;
  animation-timing-function: linear;
  text-shadow: 0 0 8px #ccc; }

@keyframes pulsate-btn-inverse {
  from {
    box-shadow: 0 0 10px #333;
    transform: rotate(-2deg); }
  to {
    box-shadow: 0 0 20px #292b2c;
    transform: rotate(2deg); } }

.page-link.pulsate {
  animation: pulsate-page-link 0.5s infinite alternate;
  animation-timing-function: linear;
  text-shadow: 0 0 8px #ccc; }

@keyframes pulsate-page-link {
  from {
    box-shadow: 0 0 10px #333;
    transform: rotate(-2deg); }
  to {
...
body {
  ...
  /* The body needs to initialize all the counters. */ }
...
.theorem::before {
  ...
  /* CSS here only applies to one word, like "Theorem." or "Example." */
  font-weight: bold;
  padding-right: 0.5em;
  font-family: -apple-system, system-ui, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif; }
...
.conjecture::before {
  /* Numbered everything in CSS is causing trouble.  TeX should decide the numbering. */
  /* content:"${nameOfClass} " counter($counterToIncrement) ". ";*/
  content: "conjecture" attr(numbered) ".";
  display: inline;
  text-transform: capitalize;
  /* CSS here only applies to one word, like "Theorem." or "Example." */
  font-weight: bold;
...
.corollary::before {
  /* Numbered everything in CSS is causing trouble.  TeX should decide the numbering. */
  /* content:"${nameOfClass} " counter($counterToIncrement) ". ";*/
  content: "corollary" attr(numbered) ".";
  display: inline;
  text-transform: capitalize;
  /* CSS here only applies to one word, like "Theorem." or "Example." */
  font-weight: bold;
...
.condition::before {
  /* Numbered everything in CSS is causing trouble.  TeX should decide the numbering. */
  /* content:"${nameOfClass} " counter($counterToIncrement) ". ";*/
  content: "condition" attr(numbered) ".";
  display: inline;
  text-transform: capitalize;
  /* CSS here only applies to one word, like "Theorem." or "Example." */
  font-weight: bold;
...
.conclusion::before {
  /* Numbered everything in CSS is causing trouble.  TeX should decide the numbering. */
  /* content:"${nameOfClass} " counter($counterToIncrement) ". ";*/
  content: "conclusion" attr(numbered) ".";
  display: inline;
  text-transform: capitalize;
  /* CSS here only applies to one word, like "Theorem." or "Example." */
  font-weight: bold;
...
.observation::before {
  /* Numbered everything in CSS is causing trouble.  TeX should decide the numbering. */
  /* content:"${nameOfClass} " counter($counterToIncrement) ". ";*/
  content: "observation" attr(numbered) ".";
  display: inline;
  text-transform: capitalize;
  /* CSS here only applies to one word, like "Theorem." or "Example." */
  font-weight: bold;
...
.algorithm::before {
  /* Numbered everything in CSS is causing trouble.  TeX should decide the numbering. */
  /* content:"${nameOfClass} " counter($counterToIncrement) ". ";*/
  content: "algorithm" attr(numbered) ".";
  display: inline;
  text-transform: capitalize;
  /* CSS here only applies to one word, like "Theorem." or "Example." */
  font-weight: bold;
...
.criterion::before {
  /* Numbered everything in CSS is causing trouble.  TeX should decide the numbering. */
  /* content:"${nameOfClass} " counter($counterToIncrement) ". ";*/
  content: "criterion" attr(numbered) ".";
  display: inline;
  text-transform: capitalize;
  /* CSS here only applies to one word, like "Theorem." or "Example." */
  font-weight: bold;
...
.procedure::before {
  /* Numbered everything in CSS is causing trouble.  TeX should decide the numbering. */
  /* content:"${nameOfClass} " counter($counterToIncrement) ". ";*/
  content: "procedure" attr(numbered) ".";
  display: inline;
  text-transform: capitalize;
  /* CSS here only applies to one word, like "Theorem." or "Example." */
  font-weight: bold;
...
.template::before {
  /* Numbered everything in CSS is causing trouble.  TeX should decide the numbering. */
  /* content:"${nameOfClass} " counter($counterToIncrement) ". ";*/
  content: "template" attr(numbered) ".";
  display: inline;
  text-transform: capitalize;
  /* CSS here only applies to one word, like "Theorem." or "Example." */
  font-weight: bold;
...
@font-face {
  ...
  src: url("/node_modules/mathjax/fonts/HTML-CSS/TeX/eot/MathJax_Math-Italic.eot");
  /* IE9 Compat Modes */
  src: url("/node_modules/mathjax/fonts/HTML-CSS/TeX/eot/MathJax_Math-Italic.eot?iefix") format("eot"), url("/node_modules/mathjax/fonts/HTML-CSS/TeX/woff/MathJax_Math-Italic.woff") format("woff"), url("/node_modules/mathjax/fonts/HTML-CSS/TeX/otf/MathJax_Math-Italic.otf") format("opentype"), url("/node_modules/mathjax/fonts/HTML-CSS/TeX/svg/MathJax_Math-Italic.svg#MathJax_Math-Italic") format("svg"); }

@font-face {
  font-family: 'MJX_Main';
  src: url("/node_modules/mathjax/fonts/HTML-CSS/TeX/eot/MathJax_Main-Regular.eot");
  /* IE9 Compat Modes */
  src: url("/node_modules/mathjax/fonts/HTML-CSS/TeX/eot/MathJax_Main-Regular.eot?iefix") format("eot"), url("/node_modules/mathjax/fonts/HTML-CSS/TeX/woff/MathJax_Main-Regular.woff") format("woff"), url("/node_modules/mathjax/fonts/HTML-CSS/TeX/otf/MathJax_Main-Regular.otf") format("opentype"), url("/node_modules/mathjax/fonts/HTML-CSS/TeX/svg/MathJax_Main-Regular.svg#MathJax_Main-Regular") format("svg"); }
...
/****************************************************************/
/* Try to spread out lines a bit for readability? */
.activity-content {
  line-height: 2.025; }
...
/****************************************************************/
/* tex4ht generates description lists from \begin{description} */
dl.description {
  margin-top: 12px;
  margin-bottom: 12px; }

dl.description dt.description {
  float: left;
  clear: left;
  padding-right: 0.5em; }

/* The styling for the abstract */
...
dl.certificate dt.page {
  padding-left: 1em; }

dl.certificate dt.page:after, dl.certificate dt.total:after {
  content: ". . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . ";
  color: #464a4c; }
...
/******* subparagraphs and paragraphs *****/
span.subparagraphHead, span.paragraphHead {
  margin-right: 1em;
  font-weight: bold; }
...
/* BADBAD: maybe this should be controlled with tex4ht somehow */
...
.carousel-logo {
  ...
  left: 25%;
  margin-right: -50%;
  transform: translate(-25%, -18%) auto;
  width: 50%;
  filter: invert(100%); }

.tex sub, .other-latex sub, .other-latex sup {
  text-transform: uppercase; }

.tex sub, .other-latex sub {
  vertical-align: 0.15ex;
  margin-left: -0.1667em;
  margin-right: -0.125em; }

.tex, .other-latex, .tex sub, .other-latex sub {
  font-size: 1em; }
...
.card-group .card.activity-card {
  ...
  @media (min-width: 11rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 1);
      flex: 0 0 calc(99.999% / 1); } }
  @media (min-width: 22rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 2);
      flex: 0 0 calc(99.999% / 2); } }
  ...
  @media (min-width: 44rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 4);
      flex: 0 0 calc(99.999% / 4); } }
  @media (min-width: 55rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 5);
      flex: 0 0 calc(99.999% / 5); } }
  @media (min-width: 66rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 6);
      flex: 0 0 calc(99.999% / 6); } }
  @media (min-width: 77rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 7);
      flex: 0 0 calc(99.999% / 7); } }
  @media (min-width: 88rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 8);
      flex: 0 0 calc(99.999% / 8); } }
  @media (min-width: 99rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 9);
      flex: 0 0 calc(99.999% / 9); } }
  @media (min-width: 110rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 10);
      flex: 0 0 calc(99.999% / 10); } }
  @media (min-width: 121rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 11);
      flex: 0 0 calc(99.999% / 11); } }
  @media (min-width: 132rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 12);
      flex: 0 0 calc(99.999% / 12); } }
  @media (min-width: 143rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 13);
      flex: 0 0 calc(99.999% / 13); } }
  @media (min-width: 154rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 14);
      flex: 0 0 calc(99.999% / 14); } }
  @media (min-width: 165rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 15);
      flex: 0 0 calc(99.999% / 15); } }
  @media (min-width: 176rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 16);
      flex: 0 0 calc(99.999% / 16); } }
  @media (min-width: 187rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 17);
      flex: 0 0 calc(99.999% / 17); } }
  @media (min-width: 198rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 18);
      flex: 0 0 calc(99.999% / 18); } }
  @media (min-width: 209rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 19);
      flex: 0 0 calc(99.999% / 19); } }
  @media (min-width: 220rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 20);
      flex: 0 0 calc(99.999% / 20); } }
  @media (min-width: 231rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 21);
      flex: 0 0 calc(99.999% / 21); } }
  @media (min-width: 242rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 22);
      flex: 0 0 calc(99.999% / 22); } }
  @media (min-width: 253rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 23);
      flex: 0 0 calc(99.999% / 23); } }
  @media (min-width: 264rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 24);
      flex: 0 0 calc(99.999% / 24); } }
  @media (min-width: 275rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 25);
      flex: 0 0 calc(99.999% / 25); } }
  @media (min-width: 286rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 26);
      flex: 0 0 calc(99.999% / 26); } }
  @media (min-width: 297rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 27);
      flex: 0 0 calc(99.999% / 27); } }
  @media (min-width: 308rem) {
    .card-group .card.activity-card {
      width: calc(99.999% / 28);
      flex: 0 0 calc(99.999% / 28); } }
...
.syntaxhighlighter code, .syntaxhighlighter .verb {
  background-color: white;
  vertical-align: top !important;
  padding: 0; }
