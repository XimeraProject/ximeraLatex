...
% First we will define a command that will *correctly* output a sage string without this text{textt{}} nonsense when in mathemode. When in non-mathmode, use \sagestr{} to call a proper string.
