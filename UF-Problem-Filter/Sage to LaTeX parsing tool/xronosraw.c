...
int main( int argc, char *argv[] )
{
	...
	p = DL_GetIniValue( "XR_InputFileHeader", NULL );
	if ( p != NULL )
	{
	...
	p = DL_GetIniValue( "XR_InputFileFooter", NULL );
	if ( p != NULL )
	{
	XTL_TrimQuotesInPlace( p );
	...
	p = DL_GetIniValue( "XR_OutputFileHeader", NULL );
	if ( p != NULL )
	{
	XTL_TrimQuotesInPlace( p );
	...
	p = DL_GetIniValue( "XR_OutputFileFooter", NULL );
	if ( p != NULL )
	{
	XTL_TrimQuotesInPlace( p );
